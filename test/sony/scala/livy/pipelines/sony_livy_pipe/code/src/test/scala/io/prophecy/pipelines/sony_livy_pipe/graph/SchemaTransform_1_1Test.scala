...
class SchemaTransform_1_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/SchemaTransform_1_1/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/SchemaTransform_1_1/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/SchemaTransform_1_1/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/SchemaTransform_1_1/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed = io.prophecy.pipelines.sony_livy_pipe.graph
      .SchemaTransform_1_1(context, dfIn)
