...
class Script_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn0 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Script_1/in0/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Script_1/in0/data/unit_test_0.json",
      "in0"
    )
    val dfOut0 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Script_1/out0/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Script_1/out0/data/unit_test_0.json",
      "out0"
    )

    val dfOut0Computed =
      io.prophecy.pipelines.sony_livy_pipe.graph.Script_1(context, dfIn0)
