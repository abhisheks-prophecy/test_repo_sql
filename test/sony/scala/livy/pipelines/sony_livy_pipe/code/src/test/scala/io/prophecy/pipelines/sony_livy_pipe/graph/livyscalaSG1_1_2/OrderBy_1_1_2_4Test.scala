...
class OrderBy_1_1_2_4Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_2/OrderBy_1_1_2_4/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_2/OrderBy_1_1_2_4/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_2/OrderBy_1_1_2_4/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_2/OrderBy_1_1_2_4/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.sony_livy_pipe.graph.livyscalaSG1_1_2
        .OrderBy_1_1_2_4(context, dfIn)
  ...
  test("Unit Test 1") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_2/OrderBy_1_1_2_4/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_2/OrderBy_1_1_2_4/in/data/unit_test_1.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_2/OrderBy_1_1_2_4/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_2/OrderBy_1_1_2_4/out/data/unit_test_1.json",
      "out"
    )
