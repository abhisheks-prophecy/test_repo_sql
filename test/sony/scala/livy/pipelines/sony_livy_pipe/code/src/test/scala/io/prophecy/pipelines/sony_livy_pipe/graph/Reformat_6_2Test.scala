...
class Reformat_6_2Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_6_2/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_6_2/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_6_2/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_6_2/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.sony_livy_pipe.graph.Reformat_6_2(context, dfIn)
