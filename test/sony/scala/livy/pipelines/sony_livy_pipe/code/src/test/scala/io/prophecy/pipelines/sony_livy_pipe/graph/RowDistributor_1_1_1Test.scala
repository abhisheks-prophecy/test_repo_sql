...
class RowDistributor_1_1_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/RowDistributor_1_1_1/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/RowDistributor_1_1_1/in/data/unit_test_0.json",
      "in"
    )
    val dfOut1 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/RowDistributor_1_1_1/out1/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/RowDistributor_1_1_1/out1/data/unit_test_0.json",
      "out1"
    )
    val dfOut0 = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/RowDistributor_1_1_1/out0/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/RowDistributor_1_1_1/out0/data/unit_test_0.json",
      "out0"
    )

    val (dfOut0Computed, dfOut1Computed) =
      io.prophecy.pipelines.sony_livy_pipe.graph
        .RowDistributor_1_1_1(context, dfIn)
