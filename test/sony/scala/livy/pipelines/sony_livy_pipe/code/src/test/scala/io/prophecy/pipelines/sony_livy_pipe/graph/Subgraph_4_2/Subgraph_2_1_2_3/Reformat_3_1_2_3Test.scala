...
class Reformat_3_1_2_3Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Subgraph_4_2/Subgraph_2_1_2_3/Reformat_3_1_2_3/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Subgraph_4_2/Subgraph_2_1_2_3/Reformat_3_1_2_3/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Subgraph_4_2/Subgraph_2_1_2_3/Reformat_3_1_2_3/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Subgraph_4_2/Subgraph_2_1_2_3/Reformat_3_1_2_3/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.sony_livy_pipe.graph.Subgraph_4_2.Subgraph_2_1_2_3
        .Reformat_3_1_2_3(context, dfIn)
  ...
  test("Unit Test 1") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Subgraph_4_2/Subgraph_2_1_2_3/Reformat_3_1_2_3/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Subgraph_4_2/Subgraph_2_1_2_3/Reformat_3_1_2_3/in/data/unit_test_1.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Subgraph_4_2/Subgraph_2_1_2_3/Reformat_3_1_2_3/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Subgraph_4_2/Subgraph_2_1_2_3/Reformat_3_1_2_3/out/data/unit_test_1.json",
      "out"
    )
