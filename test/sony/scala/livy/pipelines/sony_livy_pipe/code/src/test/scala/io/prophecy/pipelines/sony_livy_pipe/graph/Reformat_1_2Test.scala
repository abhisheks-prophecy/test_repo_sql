...
class Reformat_1_2Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.sony_livy_pipe.graph.Reformat_1_2(context, dfIn)
  ...
  test("Unit Test 1") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/in/data/unit_test_1.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/out/data/unit_test_1.json",
      "out"
    )
  ...
  test("Unit Test 2") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/in/data/unit_test_2.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/Reformat_1_2/out/data/unit_test_2.json",
      "out"
    )
