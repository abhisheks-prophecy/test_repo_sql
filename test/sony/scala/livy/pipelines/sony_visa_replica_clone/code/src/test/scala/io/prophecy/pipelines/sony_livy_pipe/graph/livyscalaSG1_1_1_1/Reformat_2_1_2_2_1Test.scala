package io.prophecy.pipelines.sony_livy_pipe.graph.livyscalaSG1_1_1_1
...
class Reformat_2_1_2_2_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_1_1/Reformat_2_1_2_2_1/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_1_1/Reformat_2_1_2_2_1/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_1_1/Reformat_2_1_2_2_1/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_1_1/Reformat_2_1_2_2_1/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.sony_livy_pipe.graph.livyscalaSG1_1_1_1
        .Reformat_2_1_2_2_1(context, dfIn)
  ...
  test("Unit Test 1") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_1_1/Reformat_2_1_2_2_1/in/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_1_1/Reformat_2_1_2_2_1/in/data/unit_test_1.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_1_1/Reformat_2_1_2_2_1/out/schema.json",
      "/data/io/prophecy/pipelines/sony_livy_pipe/graph/livyscalaSG1_1_1_1/Reformat_2_1_2_2_1/out/data/unit_test_1.json",
      "out"
    )
