...
AllStunningOne AS (
  ...
  SELECT 
    ...
    {% endif %}
    concat(C_STRING20, {{ SQL_SnowflakeSharedBasic.qa_concat_function_main_shared('c_string', 'c_integer') }}) AS c_macro_1
