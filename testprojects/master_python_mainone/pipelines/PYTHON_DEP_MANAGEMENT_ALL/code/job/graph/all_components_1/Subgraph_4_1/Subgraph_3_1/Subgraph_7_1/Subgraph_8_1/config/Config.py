from job.graph.all_components_1.Subgraph_4_1.Subgraph_3_1.Subgraph_7_1.Subgraph_8_1.Subgraph_9_1.config.Config import (
    SubgraphConfig as Subgraph_9_1_Config
)
...
class SubgraphConfig(ConfigBase):
    ...
    def __init__(
        ...
        self.Subgraph_9_1 = self.get_config_object(
            prophecy_spark, 
            Subgraph_9_1_Config(prophecy_spark = prophecy_spark), 
            Subgraph_9_1, 
            Subgraph_9_1_Config
        )
        pass
    ...
    def update(self, updated_config):
        ...
        self.Subgraph_9_1 = updated_config.Subgraph_9_1
        pass
