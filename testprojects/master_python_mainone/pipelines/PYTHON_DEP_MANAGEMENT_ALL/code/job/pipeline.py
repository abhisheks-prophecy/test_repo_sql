...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/PYTHON_DEP_MANAGEMENT_ALL")
    ...
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/PYTHON_DEP_MANAGEMENT_ALL")
    pipeline(spark)
