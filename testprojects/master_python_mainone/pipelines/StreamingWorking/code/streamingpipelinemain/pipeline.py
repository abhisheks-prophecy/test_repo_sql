...
def pipeline(spark: SparkSession) -> None:
    ...
    df_SchemaTransform_1 = SchemaTransform_1(spark, df_SetOperation_2)
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/StreamingWorking")
    ...
    MetricsCollector.start(spark = spark, pipelineId = "pipelines/StreamingWorking")
    pipeline(spark)
