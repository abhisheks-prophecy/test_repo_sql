...
from com.main1.pythondepmanagement_1.graph.SetOperation_1 import *
...
class SetOperation_1Test(BaseTestCase):
    ...
    def test_unit_test_0(self):
        dfIn0 = createDfFromResourceFiles(
            ...
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in0/data/test_unit_test_0.json',
            'in0'
        )
        dfIn1 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in1/schema.json',
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in1/data/test_unit_test_0.json',
            'in1'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/out/schema.json',
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/out/data/test_unit_test_0.json',
            'out'
        )
    ...
    def test_unit_test_1(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in0/schema.json',
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in0/data/test_unit_test_1.json',
            'in0'
        )
        dfIn1 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in1/schema.json',
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in1/data/test_unit_test_1.json',
            'in1'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/out/schema.json',
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/out/data/test_unit_test_1.json',
            'out'
        )
        dfOutComputed = SetOperation_1(self.spark, dfIn0, dfIn1)
        assertDFEquals(
    ...
    def test_unit_test_2(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in0/schema.json',
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in0/data/test_unit_test_2.json',
            'in0'
        )
        dfIn1 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in1/schema.json',
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/in1/data/test_unit_test_2.json',
            'in1'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/out/schema.json',
            'test/resources/data/com/main1/pythondepmanagement_1/graph/SetOperation_1/out/data/test_unit_test_2.json',
            'out'
        )
        dfOutComputed = SetOperation_1(self.spark, dfIn0, dfIn1)
        assertDFEquals(
