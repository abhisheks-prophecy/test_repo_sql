...
from livy_python.graph.Reformat_3 import *
...
class Reformat_3Test(BaseTestCase):
    ...
    def test_unit_test_0(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/livy_python/graph/Reformat_3/in0/schema.json',
            'test/resources/data/livy_python/graph/Reformat_3/in0/data/test_unit_test_0.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/livy_python/graph/Reformat_3/out/schema.json',
            'test/resources/data/livy_python/graph/Reformat_3/out/data/test_unit_test_0.json',
            'out'
        )
