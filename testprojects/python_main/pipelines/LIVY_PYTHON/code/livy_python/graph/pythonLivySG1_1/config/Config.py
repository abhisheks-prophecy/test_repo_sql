from livy_python.graph.pythonLivySG1_1.Subgraph_2_1.config.Config import SubgraphConfig as Subgraph_2_1_Config
...
class SubgraphConfig(ConfigBase):
    ...
    def update(self, updated_config):
        ...
        self.Subgraph_2_1 = updated_config.Subgraph_2_1
        pass
