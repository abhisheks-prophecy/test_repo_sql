from pythonorganization.donot.openme12.graph.all_type_main_1.Subgraph_1.config.Config import (
    SubgraphConfig as Subgraph_1_Config
)
from pythonorganization.donot.openme12.graph.all_type_main_1.Subgraph_2.config.Config import (
    SubgraphConfig as Subgraph_2_Config
)
from pythonorganization.donot.openme12.graph.all_type_main_1.Subgraph_4_1_1.config.Config import (
