...
from com.main.pythondepmanagement_1.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "7235/pipelines/DONOT_OPEN_PYTHON")
    ...
    MetricsCollector.start(spark = spark, pipelineId = "7235/pipelines/DONOT_OPEN_PYTHON")
    pipeline(spark)
