...
class Reformat_2Test(BaseTestCase):
    ...
    def test_unit_test_5(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/data/test_unit_test_5.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/data/test_unit_test_5.json',
            'out'
        )
        dfOutComputed = Reformat_2(self.spark, dfIn0)
    ...
    def test_unit_test_6(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/data/test_unit_test_6.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/data/test_unit_test_6.json',
            'out'
        )
        dfOutComputed = Reformat_2(self.spark, dfIn0)
    ...
    def test_unit_test_7(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/data/test_unit_test_7.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/data/test_unit_test_7.json',
            'out'
        )
        dfOutComputed = Reformat_2(self.spark, dfIn0)
    ...
    def test_unit_test_8(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/data/test_unit_test_8.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/data/test_unit_test_8.json',
            'out'
        )
        dfOutComputed = Reformat_2(self.spark, dfIn0)
    ...
    def test_unit_test_9(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/in0/data/test_unit_test_9.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/schema.json',
            'test/resources/data/pythonbasic/test/mainone/graph/Reformat_2/out/data/test_unit_test_9.json',
            'out'
        )
        dfOutComputed = Reformat_2(self.spark, dfIn0)
