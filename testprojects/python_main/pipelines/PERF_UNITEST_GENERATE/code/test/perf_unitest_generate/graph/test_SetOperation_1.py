...
from perf_unitest_generate.graph.SetOperation_1 import *
...
class SetOperation_1Test(BaseTestCase):
    ...
    def test_unit_test_0(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/perf_unitest_generate/graph/SetOperation_1/in0/schema.json',
            'test/resources/data/perf_unitest_generate/graph/SetOperation_1/in0/data/test_unit_test_0.json',
            'in0'
        )
        dfIn1 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/perf_unitest_generate/graph/SetOperation_1/in1/schema.json',
            'test/resources/data/perf_unitest_generate/graph/SetOperation_1/in1/data/test_unit_test_0.json',
            'in1'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/perf_unitest_generate/graph/SetOperation_1/out/schema.json',
            'test/resources/data/perf_unitest_generate/graph/SetOperation_1/out/data/test_unit_test_0.json',
            'out'
        )
