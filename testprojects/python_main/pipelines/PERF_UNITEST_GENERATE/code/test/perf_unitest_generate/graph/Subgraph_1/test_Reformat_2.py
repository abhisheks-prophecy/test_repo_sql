...
from perf_unitest_generate.graph.Subgraph_1.Reformat_2 import *
...
class Reformat_2Test(BaseTestCase):
    ...
    def test_unit_test_0(self):
        dfIn0 = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/perf_unitest_generate/graph/Subgraph_1/Reformat_2/in0/schema.json',
            'test/resources/data/perf_unitest_generate/graph/Subgraph_1/Reformat_2/in0/data/test_unit_test_0.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/perf_unitest_generate/graph/Subgraph_1/Reformat_2/out/schema.json',
            'test/resources/data/perf_unitest_generate/graph/Subgraph_1/Reformat_2/out/data/test_unit_test_0.json',
            'out'
        )
