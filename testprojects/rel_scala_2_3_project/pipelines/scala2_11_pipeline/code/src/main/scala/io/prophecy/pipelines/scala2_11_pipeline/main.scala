package io.prophecy.pipelines.scala2_11_pipeline
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf
      .set("prophecy.metadata.pipeline.uri", "pipelines/scala2_11_pipeline")
    MetricsCollector.start(spark,            "pipelines/scala2_11_pipeline")
    apply(context)
