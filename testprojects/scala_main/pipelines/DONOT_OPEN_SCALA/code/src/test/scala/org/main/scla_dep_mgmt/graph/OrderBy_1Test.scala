...
class OrderBy_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/org/main/scla_dep_mgmt/graph/OrderBy_1/in/schema.json",
      "/data/org/main/scla_dep_mgmt/graph/OrderBy_1/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/org/main/scla_dep_mgmt/graph/OrderBy_1/out/schema.json",
      "/data/org/main/scla_dep_mgmt/graph/OrderBy_1/out/data/unit_test_0.json",
      "out"
    )
