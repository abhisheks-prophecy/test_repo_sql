...
class Filter_2Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/org/main/scla_dep_mgmt/graph/Filter_2/in/schema.json",
      "/data/org/main/scla_dep_mgmt/graph/Filter_2/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/org/main/scla_dep_mgmt/graph/Filter_2/out/schema.json",
      "/data/org/main/scla_dep_mgmt/graph/Filter_2/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed = org.main.scla_dep_mgmt.graph.Filter_2(context, dfIn)
