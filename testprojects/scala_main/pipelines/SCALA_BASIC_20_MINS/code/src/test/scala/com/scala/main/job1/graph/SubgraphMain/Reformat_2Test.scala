...
class Reformat_2Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfOutComputed = com.scala.main.job1.graph.SubgraphMain.Reformat_2(
  ...
  test("Unit Test 2") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/in/schema.json",
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/in/data/unit_test_2.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/out/schema.json",
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/out/data/unit_test_2.json",
      "out"
    )
  ...
  test("Unit Test 3") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/in/schema.json",
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/in/data/unit_test_3.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/out/schema.json",
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/out/data/unit_test_3.json",
      "out"
    )
  ...
  test("Unit Test 4") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/in/schema.json",
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/in/data/unit_test_4.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/out/schema.json",
      "/data/com/scala/main/job1/graph/SubgraphMain/Reformat_2/out/data/unit_test_4.json",
      "out"
    )
