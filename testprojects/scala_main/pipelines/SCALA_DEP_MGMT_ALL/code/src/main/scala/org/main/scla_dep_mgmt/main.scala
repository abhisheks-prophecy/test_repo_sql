...
object Main {
  ...
  def graph(spark: SparkSession): Unit = {
    ...
    val df_Deduplicate_2 = Deduplicate_2(spark, df_FlattenSchema_1).interim(
      "graph",
      "faSnoqDMQPRk7kfregn3H$$ZKCAqB4L-lusn5xKNicMr",
      "FI1jEKVQ6bkCmPl3ojML-$$3tJdDF9N0cONpOP-Xu-2l"
    )
    val df_SubGraph_1 = SubGraph_1.apply(spark, df_Deduplicate_2)
    ...
    val df_Filter_3 = Filter_3(spark, df_Join_1).interim(
      "graph",
    ...
    val df_Aggregate_1 = Aggregate_1(spark, df_OrderBy_3).interim(
      "graph",
    ...
    val (df_SQLStatement_1_out, df_SQLStatement_1_out1) = {
      val (df_SQLStatement_1_out_temp, df_SQLStatement_1_out1_temp) =
        SQLStatement_1(spark, df_Aggregate_1, df_Aggregate_1, df_Aggregate_1)
    ...
    val df_Filter_4 = Filter_4(spark, df_SQLStatement_1_out1).interim(
      "graph",
    ...
    val df_Reformat_5 = Reformat_5(spark, df_Aggregate_1).interim(
      "graph",
      "ZohJ-uI1fzL3XQKSP_Umt$$4GCMZbeofo2GO4U1MPXs6",
      "F5wuTXsiXBnYYKYOJ4870$$M0xPxSk9xE2BT2wb6Va5r"
    )
    val df_Filter_5 = Filter_5(spark, df_Reformat_5).interim(
      "graph",
    ...
    val df_OrderBy_6 = OrderBy_6(spark, df_SQLStatement_1_out).interim(
      "graph",
